    ...
    return (
      <View>
        <AtNavBar
          ...
          border={false}
          onClickLeftIcon={this.returnBeforePages}
        />
        <AtForm onSubmit={this.onSubmit.bind(this)}>
          ...
          />
          <Text className="wenbenContent">
            温馨提示：未注册过的账号，登录时将自动注册
          </Text>
          <Text className="wenbenContent">注册过的用户可凭账号密码登录</Text>
          <View className="rongqiContent">
            <AtButton size="small" type="primary" formType="submit">
              提交
            </AtButton>
          </View>
        </AtForm>
